...
urlpatterns = [
    ...
    path('acoes/<int:id>/deletar/',
         views.ActionsDeleteView.as_view(),
         name='actions_delete',
         ),
    path('acoes/comprar/',
    ...
    path('fiis/<int:id>/deletar/',
         views.FiisDeleteView.as_view(),
         name='fiis_delete',
         ),
    path('fiis/<int:p_id>/historico/<int:h_id>/deletar/',
         views.FiisHistoryDeleteView.as_view(),
         name='fiis_history_delete',
         ),
